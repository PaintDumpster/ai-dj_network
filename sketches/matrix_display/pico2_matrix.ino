// pico2_matrix.ino — Raspberry Pi Pico, clusters 4-5 (columns 45-74 globally)
// Receives binary serial commands from the ROS writer node and renders
// a waveform on a 74×30 section of the WS2815 LED matrix.
//
// Upload via Arduino IDE with the Raspberry Pi Pico board package installed.
// Select: Tools → Board → Raspberry Pi Pico
//
// This sketch is structurally identical to pico1_matrix.ino.
// The only differences are the pin assignments, cluster count, and start delay.
//
...
#define DATA_PIN_1   11   // GP11 — cluster 4
#define DATA_PIN_2   12   // GP12 — cluster 5
#define N_CLUSTERS    2
#define N_COLS       30   // 2 clusters × 15 strips/cluster
...
void setup() {
    ...
    FastLED.show();
    Serial.begin(115200);
    Serial.println("Pico 2 matrix online — clusters 4-5, 30 cols");
}
